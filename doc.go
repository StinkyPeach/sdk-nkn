...
Objective-C framework for iOS:
  ...
  gomobile bind -target=ios -ldflags "-s -w" github.com/StinkyPeach/sdk-nkn github.com/nknorg/ncp-go github.com/nknorg/nkn/v2/transaction

and Java AAR for Android:

  gomobile bind -target=android -ldflags "-s -w" github.com/StinkyPeach/sdk-nkn github.com/nknorg/ncp-go github.com/nknorg/nkn/v2/transaction
